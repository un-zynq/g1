function CScoreBoard(iLevel,pContainerPos,oParentContainer, iPlayerTeamID, iOpponentTeamID) {
    var _pStartPos;
    var _oFlagOpponent;
    var _oNicknameText;
    var _oOpponentText;
    ...
    this._init = function (iLevel,pContainerPos) {
        ...
        var oSprite = s_oSpriteLibrary.getSprite("flag_"+TEAM_LABEL[iPlayerTeamID]);
        ...
        //s_aMatches[iLevel-1]
        var oSprite = s_oSpriteLibrary.getSprite("flag_"+TEAM_LABEL[iOpponentTeamID]);
