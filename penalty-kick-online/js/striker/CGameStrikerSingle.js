...
/*
        this._vHitDir = new CANNON.Vec3(0.051054432013683,1,0.12177098632946654);
        this._vHitDir.scale(50, this._vHitDir);
*/
...
CGameStrikerSingle.prototype.playerKick = function(){
    this.addImpulseToBall({x: this._vHitDir.x, y: this._vHitDir.y, z: this._vHitDir.z});
    this._iTimePressDown = 0;
    this.goalAnimation(this._vHitDir.y);
    s_oInterface.hideHelpText();
    s_oInterface.hideMatchPointText();
