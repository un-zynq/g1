...
CGameStrikerBase.prototype._init = function (oParentContainer,iCurLevel) {
    ...
    this._oGoalKeeper = new CGoalKeeper(CANVAS_WIDTH_HALF-14, CANVAS_HEIGHT_HALF - 8, s_iGoalkeeperColor,s_szGenderOpponent,this._oContainerGame);
    ...
    ///MALE AND FEMALE PLAYER ARE NOT DISTINGISHABLE, SO WE USE ONLY MALE TO SAVE MEMORY
    this._oPlayer = new CPlayer(PLAYER_POS[GENDER_MALE].x, PLAYER_POS[GENDER_MALE].y, s_iTeamSelected,this._oFGContainer);
