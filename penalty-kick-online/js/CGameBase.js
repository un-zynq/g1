...
CGameBase.prototype._init = function(iLevel){
    ...
    this._oResultPanel = new CResultPanel(this._iCurLevel,this._oContainer,s_iTeamSelected, iOpponentTeamID);
...
CGameBase.prototype.reset = function(){
    ...
    s_iGoalkeeperColor = Math.floor(Math.random()*GOALKEEPER_NUM_COLORS);
