function CVersusPanel(oParentContainer, szGenderPlayer, szGenderOpponent){
    var _oListener;
    ...
    this._init = function(){
        ...
        var iWidth = 140;
        var iHeight = 30;
        var iX = CANVAS_WIDTH_HALF - 126;
        var iY = _oFlagPlayer.y+78;
        var oRect = new createjs.Rectangle( iX- iWidth/2, iY-iHeight/2, iWidth, iHeight);
        _oTextPlayer = new CTLText(     _oContainer, 
                                    oRect.x, oRect.y, oRect.width, oRect.height, 
                                    13, "center", "#ffffff", PRIMARY_FONT, 1,
                                    0,0,
                                    szGenderPlayer,
                                    true, true, true,
                                    false
        ...
        var iX = CANVAS_WIDTH_HALF + 130;
        //var iY = _oFlagOpponent.y+20;
        var oRect = new createjs.Rectangle( iX- iWidth/2, iY-iHeight/2, iWidth, iHeight);
        _oTextOpponent = new CTLText(     _oContainer, 
                                    oRect.x, oRect.y, oRect.width, oRect.height, 
                                    13, "center", "#ffffff", PRIMARY_FONT, 1,
                                    0,0,
                                    szGenderOpponent,
    ...
    this.show = function(iOpponent,iLevel){
        ...
        _oTextPlayer.setAlpha(0);
        _oTextOpponent.setAlpha(0);
    ...
    this.playAnims = function(){
        ...
        createjs.Tween.get(_oTextPlayer.getText()).to({alpha: 1}, 1000);
        createjs.Tween.get(_oTextOpponent.getText()).to({alpha: 1}, 1000);
