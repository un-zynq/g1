function CFinalPanel(iLevel,oParentContainer, iPlayerTeamID, iOpponentTeamID){
    var _aCbCompleted;
    var _aCbOwner;
    ...
    this._init = function(iLevel){
        ...
        var oSpriteFlag = s_oSpriteLibrary.getSprite("flag_"+TEAM_LABEL[iPlayerTeamID]);
        ...
        oSpriteFlag = s_oSpriteLibrary.getSprite("flag_"+TEAM_LABEL[iOpponentTeamID]);
    ...
    this.show = function(iPlayerGoals,iOpponentGoals,iTotScore,iLevelScore,bLose,bLastLevel, iOpponentFlag){
        ...
        var oSpriteFlag = s_oSpriteLibrary.getSprite("flag_"+TEAM_LABEL[iOpponentFlag]);
