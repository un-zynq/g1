function CInterface(iLevel,_iTotScore,oParentContainer,oFGContainer) {
    ...
    this._init = function (iLevel) {
        ...
        var iOpponentTeamID = s_aMatches[iLevel-1];
        if(s_bMultiplayer){
            iOpponentTeamID = s_aMatches[iLevel-1].team_id;
        }
        
        _oScoreBoard = new CScoreBoard(iLevel,{x: 140, y: 4},_oParentContainer, s_iTeamSelected, iOpponentTeamID);
        ...
        var szGenderPlayer = " ";
        var szGenderOpponent = " ";
        //if(s_bMultiplayer){
            //s_szGenderOpponent = s_szGenderSelected;
            szGenderPlayer = s_szGenderSelected === GENDER_MALE ? TEXT_GENDER_MEN : TEXT_GENDER_WOMEN;
            szGenderOpponent = s_szGenderOpponent === GENDER_MALE ? TEXT_GENDER_MEN : TEXT_GENDER_WOMEN;
        //}
        _oVsPanel = new CVersusPanel(_oParentContainer, szGenderPlayer, szGenderOpponent);
        
        _oFinalPanel = new CFinalPanel(iLevel,oFGContainer,s_iTeamSelected, iOpponentTeamID);
    ...
    this.showFinalPanel = function(iPlayerGoals,iOpponentGoals,iTotScore,iLevelScore,bGameOver,bLastLevel,iOpponentFlag){
        _oFinalPanel.show(iPlayerGoals,iOpponentGoals,iTotScore,iLevelScore,bGameOver,bLastLevel,iOpponentFlag);
    };
