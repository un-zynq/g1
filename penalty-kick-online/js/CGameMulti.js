...
CGameMulti.prototype._startGame = function(){
    ...
    this._oInterface.showVsPanel(s_aMatches[this._iCurLevel-1].team_id,"");
...
CGameMulti.prototype.changeScenario = function(){
    ...
    if(bCanEnd){
        ...
        var iOpponentFlag = s_aMatches[s_oGame.getCurLevel()-1].team_id;
...
CGameMulti.prototype.nextRound = function(){
    ...
    this._oInterface.reset(s_aMatches[this._iCurLevel-1].team_id);
